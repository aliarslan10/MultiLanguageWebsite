...
@section('desc') @lang('translate.İletişim')  @stop
@section('sayfatitle') @lang('translate.İletişim')  @stop
@section('breadcrumb') @lang('translate.İletişim')  @stop 
@section('baslik') @lang('translate.İletişim')   @stop
 ...
 <div id="map" style="width: 100%; height: 300px;"></div>
  ...
  <script type="text/javascript">
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 12,
      center: new google.maps.LatLng({{$value[1]}}, {{$value[2]}}), // Centered Hatay! For TURKEY = 38.963745, 35.243322
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h4 class="panel-title"> @lang('translate.İletişim Formu')  </h4>
       </div>
  <div class="panel-body">
  {!! $xcrud->render('create') !!}
  @lang('translate.24 saat içerisinde size geri dönüş yapılacaktır.')
  </div>
</div>
@stop