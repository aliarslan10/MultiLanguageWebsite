...
{
    // default connection
    public static $dbname = 'test_db'; // Your database name
    public static $dbuser = 'test_user'; // Your database username
    public static $dbpass = 'test123456++'; // // Your database password
